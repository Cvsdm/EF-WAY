...
public class CameraController : MonoBehaviour
{
    ...
    public bool rotation_mode = true;
    ...
    public void ToggleMode()
    {
        ...
        if (rotation_mode) button.GetComponentInChildren<UnityEngine.UI.Text>().text = "R"; // Rotation
        else               button.GetComponentInChildren<UnityEngine.UI.Text>().text = "T"; // Transition
    }

    void Update()
    {
        // ------------------------------------------------------------------
        // ROTATION / TRANSLATION (with 1 finger)
        // ------------------------------------------------------------------
